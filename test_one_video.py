...
parser.add_argument("--language", type=str, default='phoenix', choices=['phoenix', 'phoenix-t', 'csl'], help="The target sign language")
...
if args.language == 'phoenix':
    dataset = 'phoenix2014'
elif args.language == 'phoenix-t':
    dataset = 'phoenix2014-T'
elif args.language == 'csl':
    dataset = 'CSL-Daily' 
else:
    raise ValueError("Please select target language from ['phoenix', 'phoenix-t', 'csl'] in your command")
